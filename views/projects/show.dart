...
class _projects_show_edt extends EDTemplate {
 ...
 for (int i = 0; i < project.imgs.length; i++) { 
    out.writeString("\r\n        <a href=\"");
    out.writeString(escapeHtml( project.imgs[i] ));
    out.writeString(".jpg\"> <img src=\"");
    out.writeString(escapeHtml( project.imgs[i] ));
    out.writeString(".gif\" alt=\"view");
    out.writeString(escapeHtml(i));
    out.writeString("\"/> </a>\r\n        ");
 if(i % 2 != 0) { 
    out.writeString("\r\n            <br/>\r\n        ");
 } 
